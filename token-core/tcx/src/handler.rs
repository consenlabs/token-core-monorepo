...
use crate::api::{
    ...
    Response, SignAuthenticationMessageParam, SignAuthenticationMessageResult, SignHashesParam,
    SignHashesResult, SignParamPoc, SignResultPoc, StoreDeleteParam, StoreDeleteResult,
