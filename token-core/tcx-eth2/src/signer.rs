...
impl SignBlsToExecutionChangeParam {
    pub fn sign_bls_to_execution_change(
        ...
        for validator_index in &self.validator_index {
            ...
            signeds.push(signed_bls_to_execution_change);
        }

        let sign_bls_to_execution_change_result = SignBlsToExecutionChangeResult { signeds };
        Ok(sign_bls_to_execution_change_result)
    }
}
