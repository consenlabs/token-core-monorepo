...
impl TsmStepResponse for AppDownloadResponse {
...
impl TsmStepRequest for AppDownloadRequest {
    type Response = AppDownloadResponse;

    fn tsm_action(&self) -> &'static str {
        constants::TSM_ACTION_APP_DOWNLOAD
    }
